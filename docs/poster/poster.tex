...
\definecolor{MainColor}{HTML}{142338}
\definecolor{MyYellow}{RGB}{255, 148, 0}
\definecolor{MyRed}{HTML}{9e1030}
\definecolor{MyGreen}{RGB}{38, 78, 54}
% \

\colorlet{bordercol}{MyGreen}
\colorlet{headercol1}{MainColor}
\colorlet{headercol2}{MainColor}
\colorlet{boxcolor}{white}
% \definecolor{bordercol}{RGB}{40,40,40}
% \definecolor{headercol1}{RGB}{186,215,230}
% \definecolor{headercol2}{RGB}{80,80,80}
\colorlet{headerfontcol}{white}
...
\begin{poster}{
	...
	headerborder=none,
    boxshade=plain,
    bgColorOne = MainColor!70!white,
	bgColorTwo = MainColor!40!white
}
%%% Eye Cacther %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
...
%%% Title %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{\sf\bf
	{\fontsize{40}{50}\selectfont\textcolor{white}{\textsc{Orion, un mailleur de Delaunay}}}
}
%%% Authors %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
	\vspace{1em} {\fontsize{20}{20}\selectfont\textcolor{white}{Alexis Tardieu \& Valentin Pannetier}}
...
\setlength\fboxrule{0.5pt}
	% \fbox{
		\begin{minipage}{25em}
			...
			\includegraphics[width=25em]{ublogo.png}
		\end{minipage}
	% }
}
