...
Point* Point::GetNeighPoint (int i)
{
    return m_listOfPoints [i];
}

Edge* Point::GetNeighEdge (int i)
{
    return m_listOfEdges [i];
}

Cell* Point::GetNeighCell (int i)
{
...
void Point::InsertNeighPoint (Point* newPoint)
{
    if (newPoint == nullptr)
        return;
...
void Point::InsertNeighEdge (Edge* newEdge)
{
    if (newEdge == nullptr)
        return;
...
void Point::InsertNeighCell (Cell* newCell)
{
    if (newCell == nullptr)
        return;
...
void Point::RemoveNeighPoint (Point* pointOut)
{
...
void Point::RemoveNeighEdge (Edge* edgeOut)
{
...
void Point::RemoveNeighCell (Cell* cellOut)
{
